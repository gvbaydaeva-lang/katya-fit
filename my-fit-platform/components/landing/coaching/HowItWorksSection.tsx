...
const STEPS = [
  ...
  },
  {
    ...
    fullDescription:
      "В процессе работы вы регулярно присылаете отчёты, задаёте вопросы и получаете обратную связь. Я отслеживаю динамику, помогаю разобраться со сложностями и своевременно корректирую питание или тренировочную нагрузку.",
    details: [
      "Регулярная обратная связь по вашим отчётам",
      "Ответы на вопросы и помощь в сложных ситуациях",
      "Корректировки плана по результатам и самочувствию",
    ],
    image:
        ...
        {selectedStep && (
          <DialogContent className="max-h-[90vh] max-w-2xl gap-0 overflow-hidden rounded-sm bg-white p-0">
            <div className="min-h-0 overflow-y-auto overscroll-contain">
              ...
              <div className="relative h-52 overflow-hidden bg-[#E8E2D9] md:h-64">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img

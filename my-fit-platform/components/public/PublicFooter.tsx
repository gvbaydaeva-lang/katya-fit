      ...
      <div className="mx-auto max-w-6xl px-6 py-12">
        <div className="flex flex-col items-start gap-8 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div>
            ...
            <p className="text-[8px] font-light text-stone-400 tracking-[0.25em] uppercase mt-0.5">FITNESS &amp; NUTRITION COACH</p>
          </div>
          ...
          <div className="flex gap-4">
            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-stone-400 hover:text-[#C4956A] transition-colors">
            ...
            <a href="https://t.me" target="_blank" rel="noopener noreferrer" className="text-stone-400 hover:text-[#C4956A] transition-colors">
              <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-8 border-t border-[#E8E2D9] pt-6">
          <p className="text-xs text-stone-400">© {new Date().getFullYear()} Katy D. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );

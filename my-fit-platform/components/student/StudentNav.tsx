...
export function StudentNav({
  ...
  return (
    <aside
      className={`fixed inset-y-0 left-0 z-40 h-dvh ${STUDENT_SIDEBAR_WIDTH} max-w-[calc(100vw-2rem)] flex-col border-r border-stone-900/8 bg-ds-surface shadow-xl md:shadow-none ${className}`}
    >
      <div
      ...
      >
        ...
        <button
          type="button"
          onClick={onClose}
          className="shrink-0 rounded-lg p-2 text-ds-muted transition-colors hover:bg-ds-hover hover:text-ds-text md:hidden"

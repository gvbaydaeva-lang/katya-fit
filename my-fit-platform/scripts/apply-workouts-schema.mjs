/**
 * Применяет supabase/setup-workouts-from-scratch.sql к базе.
...
const sqlPath = resolve(root, "supabase/setup-workouts-from-scratch.sql");
...
try {
  ...
  console.log("\n✓ Таблица workouts создана. Можно сохранять уроки в админке.");
} catch {
  console.error(`
